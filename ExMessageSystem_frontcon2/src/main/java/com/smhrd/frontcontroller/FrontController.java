...
import com.smhrd.controller.CheckEamilService;
import com.smhrd.controller.FetchTest;
...
public void init(ServletConfig config) throws ServletException {
	   ...
	   map.put("FetchTest.do", new FetchTest());
	   map.put("CheckEmail.do", new CheckEamilService());
}
...
protected void service(HttpServletRequest request, HttpServletResponse response)
      ...
      if(moveUrl.contains("fetch:/")) {
          ...
          // 2. redirect:/main.jsp --> redirect 방식 이동
